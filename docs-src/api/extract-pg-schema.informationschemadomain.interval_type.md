...
[Home](./index.md) &gt; [extract-pg-schema](./extract-pg-schema.md) &gt; [InformationSchemaDomain](./extract-pg-schema.informationschemadomain.md) &gt; [interval\_type](./extract-pg-schema.informationschemadomain.interval_type.md)

## InformationSchemaDomain.interval\_type property
